...
"""
        ...
        expected_html = (
            ...
            "<p>Normal paragraph with <code>inline code</code> and <b>bold</b>.</p>"
            "</div>"
        )
        self.assertEqual(html, expected_html)
...
"""
        ...
        expected_html = (
            "<div>"
        "<p>This is a paragraph with an <img src=\"img.png\" alt=\"image\"></img> and a <a href=\"https://example.com\">link</a></p>"
        "</div>"
        )
        self.assertEqual(html, expected_html)
